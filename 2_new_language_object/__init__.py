...
import srsly
from .lemmatizer import YorubaLemmatizer
...
@spacy.registry.languages("yor") #https://nightly.spacy.io/api/top-level#registry
...
def make_lemmatizer(
    ...
    return YorubaLemmatizer(nlp.vocab, model, name, mode=mode, overwrite=overwrite)

#Add locations of lookups data to the registry
@spacy.registry.lookups("yor")
def do_registration():
    from pathlib import Path
    cadet_path = Path.cwd()
    lookups_path = cadet_path / "new_lang" / "yoruba" / "lookups"
    result = {}
